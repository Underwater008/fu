...
function initStartOverlay() {
    ...
    const updateTime = () => {
        ...
        if (nextTarget) {
            ...
            labelEl.innerHTML = `
                <div class="cny-label-en">UNTIL YEAR OF THE <span class="cny-label-highlight">${zodiac.element} ${zodiac.en}</span></div>
                <div class="cny-label-cn">
                    <span class="cny-label-char">${zodiac.cn}${zodiac.ganZhi}</span>
                    <span class="cny-label-date">${dateStr}</span>
                </div>`;
        } else {
            ...
            labelEl.innerHTML = `
                <div class="cny-label-en">SINCE YEAR OF THE <span class="cny-label-highlight">${zodiac.element} ${zodiac.en}</span></div>
                <div class="cny-label-cn">
                    <span class="cny-label-char">${zodiac.cn}${zodiac.ganZhi}</span>
                    <span class="cny-label-date">${dateStr}</span>
                </div>`;
